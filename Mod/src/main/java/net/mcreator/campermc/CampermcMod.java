...
@Mod("campermc")
public class CampermcMod {
	public static final Logger LOGGER = LogManager.getLogger(CampermcMod.class);
	public static final String MODID = "campermc";
